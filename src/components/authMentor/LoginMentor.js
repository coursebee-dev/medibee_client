                    ...
                    <div className="col s8 offset-s2">
                        ...
                        <div className="col s12" style={{ paddingLeft: "11.250px" }}>
                            ...
                            <p className="grey-text text-darken-1">
                                Don't have an account? <Link className="red-text text-darken-1" to="/mentor/register">Register</Link>
                            </p>
                        </div>
                        ...
                        <div className="col s12" style={{ marginTop: "5%" }}>
                            <Link className="red-text text-darken-1" to="/mentor/forgotpass">Forgot Password?</Link>
                        </div>
                    </div>
                </div>
            </div>
