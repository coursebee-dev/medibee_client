            ...
            <div className="col s12">
              ...
              {this.props.auth.user.adminVerify === false ? (
                <h5 className="red-text">
                  Your information is under review. We will active your account
                  within short time.
                  <br />
                  To schedule live classes or submit online courses please send
                  us an email
                </h5>
              ) : (
                <>
                  <div className="row center-align">
                    <div className="col m6 s12">
                      <Link
                        to="/mentor/dashboard/scheduleclass"
                        style={{
                          margin: "5%",
                          padding: "0",
                          width: "400px",
                      ...
                      >
                        ...
                        <div className="purple accent-1 white-text">
                          Schedule A Live Class Now
                        </div>
                      </Link>
                    </div>
...
export default connect(mapStateToProps, { logoutUser })(DashboardMentor);
