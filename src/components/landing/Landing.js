        ...
        <div>
          <div className="center-align container">
            ...
            <p className="flow-text grey-text text-darken-1">
              ...
              To be one of the first students in MEDIBEE<br />
            </p>
            <h4>Register Now</h4>
            <br />
            <div style={{ maxWidth: "600px", display: "flex", justifyContent: "space-evenly" }} className="container">
              <div>
                <Link to="/register" style={{ margin: "10px", width: "140px", borderRadius: "3px", letterSpacing: "1.5px" }} className="btn btn-large waves-effect waves-light hoverable blue darken-1  black-text">
                  Register
              </Link>
              </div>
              <div>
                <Link to="/login" style={{ margin: "10px", width: "140px", borderRadius: "3px", letterSpacing: "1.5px" }} className="btn btn-large waves-effect hoverable red darken-1">
                  Log In
              </Link>
              </div>
            </div>
