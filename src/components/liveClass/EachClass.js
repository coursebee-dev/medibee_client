      ...
      <div className="card custom-card">
          ...
          <div className="row">
            <div className="col">
              ...
              <p>
                {" "}
                {new Date(
                  liveClass?.classtimes[0].date +
                    "T" +
                    liveClass?.classtimes[0].time
                ).toLocaleString()}
              </p>
            </div>
            ...
            <div className="col">
              Number of classes: {liveClass?.classtimes.length}
            </div>
          </div>
        </div>
        <div className="card-action">
          <div className="row">
            ...
            {show ? (
              <Link
                to={`/liveclass/confirm/${liveClass?._id}`}
                style={{
                  width: "100%",
                  marginTop: "20px",
                  fontWeight: "bold",
                }}
                className=" btn btn-flat  blue darken-4 white-text custom_btn"
              >
...
export default connect(mapStateToProps)(EachClass);
