...
import QuesBank from "./components/questionBank/questionBank";
    ...
    <Switch>
      <React.Fragment>
        ...
        <main className="no-padding">
          ...
          <Route exact path="/questionbank" component={QuesBank} />
          <PrivateRoute exact path="/dashboard" component={Dashboard} />

          <PrivateRoute
            exact
            path="/dashboard/myliveclass/:id"
            component={MyLiveClass}
          />
          <PrivateRoute
            exact
            path="/liveclass/confirm/:id"
            component={ConfirmLiveRegistration}
          />
          <PrivateRouteMentor
            exact
          ...
          <PrivateRouteMentor
            exact
            path="/mentor/dashboard/scheduleclass"
          ...
          <PrivateRouteAdmin
            exact
            path="/admin/dashboard/viewmentor/:mentorid"
            component={ViewMentorDetail}
          />
          <PrivateRouteAdmin
            exact
            path="/admin/dashboard/viewliveclass"
          ...
          <PrivateRouteAdmin
            exact
            path="/admin/dashboard/studentroles"
            component={StudentRoles}
          />
          <PrivateRouteAdmin
            exact
            path="/admin/dashboard/questionBank/dashboard"
            component={QuesBankDashboard}
          />
        </main>
        <Footer />
      </React.Fragment>
